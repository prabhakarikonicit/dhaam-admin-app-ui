        ...
        <div className="flex flex-col sm:flex-row justify-between items-center mb-6 gap-4 rounded-custom10px bg-backgroundWhite p-4">
          <div className="relative w-full sm:w-auto sm:flex-1 max-w-lg">
            ...
            <input
              ...
              className="block w-full md:w-[213px] pl-10 pr-3 py-2 border border-grey-border rounded-custom7px leading-5 text-[12px] text-cardTitle font-inter font-[500] bg-white shadow-sm focus:outline-none focus:ring-1 focus:ring-bgButton focus:border-purple-500 sm:text-[12px]"
              value={searchTerm}
