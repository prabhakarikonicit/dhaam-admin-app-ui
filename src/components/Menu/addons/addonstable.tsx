...
const AddonsTable: React.FC = () => {
  ...
  return (
    <div className="p-3 bg-white rounded-custom12px">
      <div className="bg-white rounded-custom8px overflow-hidden border border-reloadBorder mb-24">
        {/* Header section */}
        <div className="py-4 px-3 flex justify-between items-center bg-white border-b border-reloadBorder ">
          ...
          <div className="flex items-center space-x-4">
            <div className="relative">
              ...
              {/* Column menu dropdown remains the same */}
            </div>
            <div className="relative">
              <button
              ...
              {/* Filter menu dropdown remains the same */}
            </div>
            <div className="relative">
              <button
                className="flex items-center text-[12px] font-inter font-[500] text-textHeading"
              ...
              <tr>
                <th scope="col" className="w-12 px-6 py-3 text-left">
                  <input
                    ...
                    checked={
                      selectedItems.length === addons.length &&
                      addons.length > 0
                    }
