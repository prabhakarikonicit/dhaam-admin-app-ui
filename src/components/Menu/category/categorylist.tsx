...
interface CategoryListProps {
  ...
  handleDuplicateCategory: (category: CategoryItem) => void;
  handleDuplicateSubcategory: (category: CategoryItem, subcategory: SubcategoryItem) => void;
  handleDuplicateSubSubcategory: (category: CategoryItem, subcategory: SubcategoryItem, subsubcategory: SubSubcategoryItem) => void;
}
...
const CategoryList: React.FC<CategoryListProps> = ({
  ...
  handleDuplicateSubcategory,
  handleDuplicateSubSubcategory,
}) => {
  ...
  return (
    <div className="min-h-screen flex-grow overflow-auto h-[calc(100vh-50px)] scrollbar-hide">
      <div className="">
            ...
            {filteredCategories.map((category) => (
              <div key={category.id} className="mb-4 relative">
                ...
                {expandedCategories[category.id] && (
                  <div className="absolute left-4 top-16 w-px h-[calc(100%-90px)] md:h-[calc(100%-100px)] border border-grey-border"></div>
                )}
                <div
                ...
                {expandedCategories[category.id] && category.subcategories && (
                  <div className="pl-8 mt-2 relative">
                    {category.subcategories.map((subcategory, index) => (
                      <div key={subcategory.id} className="mb-4 relative">
                        {/* Horizontal line to subcategory */}
                        <div className="absolute left-[-12px] md:top-8 top-10 w-[20px] h-px border border-grey-border"></div>

                        {/* Vertical line from subcategory down */}
                        {expandedSubcategories[subcategory.id] && (
                          <div className="absolute left-10 top-16 w-px h-[calc(100%-107px)] md:h-[calc(100%-94px)] border border-grey-border"></div>
                        )}
                        <div
                        ...
                        >
                          <div className="flex items-center ps-4">
                            <div className="mr-2 flex items-center">
                              <ExpansionIcon
                                isExpanded={
                                  expandedSubcategories[subcategory.id] || false
                                }
                              />
                            </div>
 ...
 "
                                  ...
                                  <button
                                    ...
                                    onClick={(e) => {
                                      e.stopPropagation();
                                      handleDuplicateSubcategory(category, subcategory);
                                    }}
                                  >
                                    Duplicate
                                  </button>
                        ...
                        {expandedSubcategories[subcategory.id] && ( 
                            <div className="pl-[50px] mt-2 relative ">
                              {(subcategory.subSubcategories|| []).map(
                                (subsubcategory) => (
                                  ...
                                  >
                                    <div
                                      key={subsubcategory.id}
                                      className={`subcategory-item py-2  flex justify-between items-center cursor-pointer relative  ${
                                        isSelected(
                                          "subSubcategory",
                                          subsubcategory.id
                                        )
                                          ? "border border-cardTitle -ps-4 rounded-custom8px "
                                          : ""
                                      }`}
                                      onClick={(e) => {
                                        e.stopPropagation();
                                    ...
                                    >
                                      {/* Horizontal line to sub-subcategory */}
                                      <div className="absolute left-[-20px] top-8 w-[24px] h-px border-t border-grey-border"></div>
                                          ...
                                          {openSubSubcatMenu ===
                                            ...
                                            <div className="absolute right-0 mt-1 w-50 bg-white rounded-md shadow-lg z-50 py-1 border border-gray-200">
                                              ...
                                              <button
                                                ...
                                                onClick={(e) => {
                                                  e.stopPropagation();
                                                  handleDuplicateSubSubcategory(category, subcategory, subsubcategory);
                                                }}
                                              >
                                                Duplicate
                                              </button>
