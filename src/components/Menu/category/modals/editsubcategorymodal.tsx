...
const EditSubcategoryModal: React.FC<EditSubcategoryModalProps> = ({
  ...
  const handleSave = () => {
    ...
    const name = (document.getElementById("edit-subcat-name") as HTMLInputElement).value;
    const description = (
      document.getElementById("edit-subcat-description") as HTMLTextAreaElement
    ).value;
    const product = (
      document.getElementById("edit-subcat-product") as HTMLSelectElement
    ).value;
