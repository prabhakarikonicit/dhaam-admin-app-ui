...
import { CategoryItem, SubcategoryItem, FormData, ModalProps } from "../categorytypes";

interface SubSubcategoryModalProps extends ModalProps {
  currentParentCategory: CategoryItem | null;
  currentSubcategoryItem: SubcategoryItem | null;
}

const SubSubcategoryModal: React.FC<SubSubcategoryModalProps> = ({
  isOpen,
  onClose,
  onSave,
  ...
  const handleSave = () => {
    ...
    const name = (document.getElementById("subsubcat-name") as HTMLInputElement).value;
    const description = (
      document.getElementById("subsubcat-description") as HTMLTextAreaElement
    ).value;
    const product = (
      document.getElementById("subsubcat-product") as HTMLSelectElement
    ).value;
    const addMore = (document.getElementById("addMoreSubSub") as HTMLInputElement).checked;
    ...
    if (addMore) {
      (document.getElementById("subsubcat-name") as HTMLInputElement).value = "";
      (document.getElementById("subsubcat-description") as HTMLTextAreaElement).value = "";
      (document.getElementById("subsubcat-product") as HTMLSelectElement).value = "";
    }
  };
          ...
          <div>
            ...
            <div className="mb-4">
              ...
              <div className="flex items-center">
                ...
                />
                <label htmlFor="addMoreSubSub" className="ml-2 text-gray-700">
                  Add more
                </label>
              </div>
            </div>
