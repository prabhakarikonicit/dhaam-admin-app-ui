...
const Combos: React.FC = () => {
  ...
  return (
    <div className="bg-background-grey rounded-lg shadow-sm border border-gray-100 min-h-screen flex-grow overflow-y-auto h-[calc(100vh-20px)] max-w-full">
                          ...
                          <td className="px-6 py-4">
                            <div className="flex items-center">
                              <div className="h-14 w-14 flex-shrink-0 bg-gray-100 rounded-md overflow-hidden mr-3">
                                <img
                                  src={`https://source.unsplash.com/100x100/?food,${combo.name
                                    .toLowerCase()
                                    .split(" ")
                                    .join("-")}`}
                                  alt={combo.name}
