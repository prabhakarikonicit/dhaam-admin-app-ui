    ...
    return (
      <div className="max-w-3xl rounded-lg p-6 sm:max-h-full md:max-h-full lg:max-h-full xl:max-h-full max-h-[80vh] overflow-y-auto sm:overflow-visible md:overflow-visible lg:overflow-visible xl:overflow-visible">
        <div className="flex justify-between items-center mb-3">
          <h2 className="text-[14px] font-inter font-[600px] text-headding-color leading-[21px] mb-3">Domain</h2>
        ...
        <form className="space-y-6 bg-backgroundWhite p-6 rounded-lg">
          ...
          <div className="mt-8">
            ...
            <div className="flex items-center justify-between mb-4">
              <span className="text-[10px] font-inter font-[500px] text-paragraphBlack">
                Learn about how to setup existing domain to dhaam website
              </span>
              <button className="text-[12px] w-[250px] font-inter font-[500px] text-paragraphBlack hover:text-purple-700">
                Learn More
              </button>
            </div>
