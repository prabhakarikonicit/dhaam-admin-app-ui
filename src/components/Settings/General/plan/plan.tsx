  ...
  return (
    <div className="max-w-3xl rounded-lg sm:max-h-full md:max-h-full lg:max-h-full xl:max-h-full max-h-[80vh] overflow-y-auto sm:overflow-visible md:overflow-visible lg:overflow-visible xl:overflow-visible">
      ...
      <div className="space-y-6">
        <div className="bg-backgroundWhite rounded-custom p-6">
          ...
          <div className="border border-reloadBorder rounded-lg p-4 relative">
            ...
            <div className="hidden sm:flex md:flex lg:flex xl:flex justify-between items-start mb-6">
              ...
              <div className="px-4 py-1 bg-backgroundWhite border border-reloadBorder rounded-full text-[12px] font-inter font-[500] text-paragraphBlack">
            ...
            <div className="block sm:hidden md:hidden lg:hidden xl:hidden">
              <div className="mb-4">
                <div className="px-4 py-1 bg-backgroundWhite border border-reloadBorder rounded-full text-[12px] font-inter font-[500] text-paragraphBlack inline-block">
                  Plan expires on : Feb 13, 2026
                </div>
              </div>
        ...
        <div className="flex items-center justify-between py-3 px-4 bg-backgroundWhite rounded-lg">
        ...
        <div className="bg-backgroundWhite p-6 rounded-custom">
          <div className="flex items-center justify-between mb-4">
            <span className="text-[12px] font-inter font-[600] text-paragraphBlack">
              Learn about plans
            </span>
            <button className="text-[12px] font-inter font-[600] text-paragraphBlack">
              Learn More
            </button>
          </div>
