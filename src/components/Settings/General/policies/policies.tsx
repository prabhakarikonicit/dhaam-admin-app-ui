...
const PoliciesAndPages: React.FC<PoliciesAndPagesProps> = ({
  ...
  return (
    <div className="p-1 md:p-0 sm:p-0 lg:p-0 xl:p-0 max-w-full rounded-custom12px sm:max-h-full md:max-h-full lg:max-h-full xl:max-h-full max-h-[80vh] overflow-y-auto sm:overflow-visible md:overflow-visible lg:overflow-visible xl:overflow-visible">
      {/* Header */}
