...
const Store: React.FC = () => {
  ...
  return (
    <div className="max-w-4xl md:max-w-4xl sm:max-w-4xl lg:max-w-4xl xl:max-w-4xl rounded-lg p-1 md:p-6  lg:p-6 lg:p-6 xl:p-6 sm:max-h-full md:max-h-full lg:max-h-full xl:max-h-full max-h-[80vh] overflow-y-auto sm:overflow-visible md:overflow-visible lg:overflow-visible xl:overflow-visible bg-gray-50 min-h-screen p-4">
      {/* Header */}
      <div className="flex justify-between items-center mb-4 bg-white p-4 rounded-md">
        ...
        <div className="flex space-x-2">
          ...
          <button className="px-4 py-2 bg-gray-100 rounded-md text-gray-800 hover:bg-gray-200">
            Save
          </button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-1 gap-4">
        ...
        <div className="space-y-4">
          ...
          {/* Preparation Time */}
          <div className="bg-white rounded-lg p-6 mb-4">
            <h2 className="text-[14px] font-inter font-[600] text-textHeading mb-2">Preparation Time</h2>
