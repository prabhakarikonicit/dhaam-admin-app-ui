...
import StoreMobileView from "../stores/storemobileview";
import OrderMobileView from "../orders/ordermobileview";
...
const CustomDataGrid: React.FC<DataGridProps> = ({
  ...
  return (
    ...
    <div
      className={`w-full bg-backgroundWhite mb-10 ${
        showBorder ? "border border-reloadBorder rounded-custom" : ""
      }`}
    >
          ...
          {isMobile ? (
            <div className="w-full flex flex-row gap-2 items-center mt-2">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="pl-10 pr-4 py-2 border border-grey-border rounded-custom7px text-[12px] font-inter font-[400] text-cardTitle w-full"
                />
              </div>
            ...
            <div className="relative w-full sm:w-auto mt-2 sm:mt-0">
              ...
              <input
                ...
                onChange={(e) => setSearchValue(e.target.value)}
                placeholder={searchPlaceholder}
                className="pl-10 pr-4 py-2 border border-grey-border rounded-custom7px text-[12px] font-inter font-[400] text-cardTitle w-full sm:w-64 md:w-80 lg:w-96 xl:w-120"
              />
            </div>
          )}
        </div>
            ...
            <tbody>
              {filteredRows
                ...
                .map((row) => (
                  <tr
                    key={row.id}
                    className="border-b  border-reloadBorder  bg-store-card"
                  >
                    {showCheckboxes && (
