...
// File Upload Component with optional delete icon
 const FileUpload: React.FC<{
  ...
  return (
    <div className="mb-6 bg-backgroundWhite">
      <div className="flex items-center mb-1">
        ...
        {dimensions && <span className="text-[12px] font-inter text-cardTitle ml-2">({dimensions})</span>}
      </div>
  ...
  <path d="M15.833 5.83333L15.1102 15.9521C15.0479 16.8243 14.3222 17.5 13.4478 17.5H6.55154C5.67714 17.5 4.95141 16.8243 4.88911 15.9521L4.16634 5.83333M8.33301 9.16667V14.1667M11.6663 9.16667V14.1667M12.4997 5.83333V3.33333C12.4997 2.8731 12.1266 2.5 11.6663 2.5H8.33301C7.87277 2.5 7.49967 2.8731 7.49967 3.33333V5.83333M3.33301 5.83333H16.6663" stroke="#DB1F1F" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
          </button>
        </div>
      ) : (
        <div 
          className="border border-dashed rounded-md p-6 flex flex-col items-center justify-center text-center cursor-pointer hover:bg-gray-50" 
          onClick={handleClick}
