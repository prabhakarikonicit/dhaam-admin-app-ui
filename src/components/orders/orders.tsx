...
import OrderPopover from "../orders/orderpopover";
import OrderDetailPage from "./ordersdetails";
interface Order {
  id: string;
  orderId: string;
  amount: string;
...
const Orders: React.FC = () => {
  ...
  useEffect(() => {
    function handleClickOutside(event: MouseEvent) {
      ...
      // Your existing click outside handlers for other refs...
    }
  ...
  }, [mobileMenuOpen]); // Add mobileMenuOpen to the dependency array
  ...
  const columns: Column[] = [
    ...
    },
    {
      ...
      renderCell: (value, row) => (
        <div>
          <div className=" text-[12px] font-inter font-[600] text-headding-color whitespace-nowrap overflow-hidden text-ellipsis bg-subMenus py-1 px-3 rounded-custom80px text-center">
            {value}
          </div>
        </div>
      ),
  ...
  return (
    <div className="p-0 max-w-full rounded-lg p-1 md:p-6 lg:p-0 xl:p-0 sm:max-h-full md:max-h-full lg:max-h-full xl:max-h-full max-h-[80vh] overflow-y-auto bg-background-grey">
      {/* Header with search and buttons - Mobile Responsive with Three Dots Menu */}
      <div className="hidden md:flex justify-between items-center mb-6 px-8 pt-8">
            ...
            {storesDropdownOpen && (
              <div className="absolute right-0 mt-2 bg-white shadow-lg rounded-custom border border-reloadBorder w-43 z-10">
                <div className="py-1">
                  <a
                    href="#"
                    className="block px-4 py-2 text-menuSubHeadingColor font-inter text-[12px] font-[500] hover:bg-background-grey hover:underline"
                  >
                    All stores
                  </a>
                  <a
                    href="#"
                    className="block px-4 py-2 whitespace-nowrap text-menuSubHeadingColor font-inter text-[12px] font-[500] hover:bg-background-grey hover:underline"
                  >
                    Public House
                  </a>
                  <a
            ...
            {actionsDropdownOpen && (
              <div className="absolute right-0 mt-2 bg-white shadow-lg rounded-custom border border-reloadBorder w-43 z-10">
                <div className="py-1">
                  ...
                  <a
                    href="#"
                    className="block px-4 py-2 text-menuSubHeadingColor whitespace-nowrap font-inter text-[12px] font-[500] hover:bg-background-grey hover:underline"
                  >
                    Create new view
                  </a>
                  <a
      ...
      <div className="flex md:hidden justify-between items-center mb-4 px-4 pt-4">
        <h1 className="text-[16px] font-inter font-[600] text-cardValue">
          Orders
        </h1>

        <div className="flex items-center space-x-2">
          {/* Create order button - first on mobile */}
          <button
            className="bg-bgButton text-whiteColor font-inter text-[10px] font-[600] border border-btnBorder rounded-md px-4 py-2 flex items-center shadow-sm"
            onClick={handleCreateOrder}
          >
            Create order
            <Plus className="ml-1 h-4 w-4" />
          ...
          <button className="p-2 bg-white border border-reloadBorder rounded-md">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
              height="20"
          ...
          <div className="relative" ref={mobileMenuRef}>
            <button
              className="p-2 bg-white border border-reloadBorder rounded-md"
            ...
            {mobileMenuOpen && (
              <div className="absolute right-0 mt-2 bg-white shadow-lg rounded-custom border border-reloadBorder w-48 z-10">
                <div className="py-1">
                  <a
                    href="#"
                    className="block px-4 py-2 text-menuSubHeadingColor font-inter text-[14px] font-[500]"
                  >
                    More Actions
                  </a>
                  <a
